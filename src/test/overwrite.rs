...
#[test]
fn afssi_5020() {
    let mut result = crate::overwrite::afssi_5020_overwrite_file("data/afssi_5020_overwrite_file.txt");
    assert!(result.is_ok());
...
#[test]
fn dod_522022_me() {
    let mut result = crate::overwrite::dod_522022_me_overwrite_file("data/dod_522022_me_overwrite_file.txt");
    assert!(result.is_ok());
    assert!(std::path::Path::new("data/dod_522022_me_overwrite_file.txt").exists());
    result = crate::overwrite::dod_522022_me_overwrite_file("data/dod_522022_me_overwrite_file1.txt");
    assert!(result.is_err());
}

#[test]
fn dod_522022_mece() {
    let mut result = crate::overwrite::dod_522022_mece_overwrite_file("data/dod_522022_mece_overwrite_file.txt");
    assert!(result.is_ok());
    assert!(std::path::Path::new("data/dod_522022_mece_overwrite_file.txt").exists());
    result = crate::overwrite::dod_522022_mece_overwrite_file("data/dod_522022_mece_overwrite_file1.txt");
    assert!(result.is_err());
}
...
fn rcmp_tssit_ops_ii(){
    let mut result = crate::overwrite::rcmp_tssit_ops_ii_overwrite_file("data/rcmp_tssit_ops_ii_overwrite_file.txt");
    assert!(result.is_ok());
...
fn zero_overwrite(){
    ...
    assert!(result.is_ok());
    result =  crate::utils::file_overwriting_hexa("data/rcmp_tssit_ops_ii_overwrite_file1.txt",0x00_u8);
    assert!(result.is_err());
}